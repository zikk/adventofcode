    ...
    for (_, v) in antennas.iter() {
        for i in 0..v.len() {
            ...
            for j in 0..v.len() {
                ...
                let y_diff = anchor.y - comp.y;
                let x_diff = anchor.x - comp.x;

                input[anchor.y as usize][anchor.x as usize] = '#';
                input[comp.y as usize][comp.x as usize] = '#';
                ...
                loop {
                    ...
                    antinode_pos = Pos {
                        y: antinode_pos.y + y_diff,
                        x: antinode_pos.x + x_diff,
                    }
                }
            }
        }
